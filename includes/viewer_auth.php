...
/**
 * Viewer Authentication and Authorization Helper
 * 
 * This file contains functions to check if a user is authenticated
 * and has Viewer role. Viewers have read-only access.
 */

/**
 * Check if the current user is authenticated and is a Viewer
 ...
 * Returns true if Viewer, false otherwise
 */
function isViewer() {
