...
<div class="report-card">
    ...
    <?php if (!empty($reportQueryError)): ?>
        <div class="print-hidden" style="margin-bottom: 15px; padding: 10px 12px; border: 1px solid #fecaca; background: #fef2f2; color: #991b1b; border-radius: 6px; font-size: 11px;">
    ...
    <!-- Print Footer Info -->
    <div style="margin-top: 30px; text-align: center; font-size: 10px; color: #64748b; border-top: 1px solid #e2e8f0; padding-top: 8px;">
