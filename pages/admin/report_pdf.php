...
'.date('F d, Y h:i A').'</td></tr></table><table class="report"><thead><tr><th width="8%">Image</th><th width="12%">Code</th><th width="20%">Product</th><th width="12%">Category</th><th width="8%">Begin</th><th width="8%">In</th><th width="8%">Out</th><th width="8%">Return</th><th width="8%">End</th><th width="8%">Cost</th><th width="10%">Value</th></tr></thead><tbody>
...
PRODUCT IMAGE
==================================================*/
$imagePath=realpath(__DIR__ . "/../../assets/images/no-image.png");
if(!empty($image)){
$possible=realpath(__DIR__ . "/../../".$image);
...
$html .= '</tbody><tfoot><tr><td colspan="4"style="
background:#e5e7eb;
font-weight:bold;
text-align:right;">

GRAND TOTAL</td><td align="center">

'.number_format($grandBeginning).'</td><td align="center">

'.number_format($grandIn).'</td><td align="center">

'.number_format($grandOut).'</td><td align="center">

'.number_format($grandReturn).'</td><td align="center">

'.number_format($grandEnding).'</td><td></td><td align="right">

₱'.number_format($grandValue,2).'</td></tr></tfoot></table><br><br><table width="100%"><tr><td width="33%" align="center">

_____________________________<br><b>Prepared By</b><br>

'.htmlspecialchars($_SESSION['fullname']).'<br>

'.htmlspecialchars($_SESSION['role']).'</td><td width="33%" align="center">

_____________________________<br><b>Checked By</b><br>

Merchandising Office Coordinator</td><td width="34%" align="center">

_____________________________<br><b>Approved By</b><br>

Campus Administrator</td></tr></table><div style="
margin-top:30px;
text-align:center;
font-size:10px;
color:#666;">
...
ISU Inventory Management & Billing System</b><br>

'.date('F d, Y h:i:s A').'</div></body></html>
